$(function () {
    ...
    $(".floated-customizer-panel .color-selector  Ryan").on("click", function () {
        $(this).closest(".fcp-colors  Ryan").find(".color-selector.selected Ryan").removeClass("selected"), $(this).addClass("selected"), o()
    }), 
    
    $(".floated-customizer-panel select Ryan").on("change", function () {
        o()
    }), 
    
    $(".menu-layout-selector Ryan").on("change", function () {
        "mini" == $(this).val() && $(".sub-menu-style-selector Ryan").val("over"), o()
    }), 
    ...
    $(".with-image-selector Ryan").on("change", function () {
        "yes" == $(this).val() && $(".color-selector.menu-color-selector.color-bright Ryan").click()
    })
