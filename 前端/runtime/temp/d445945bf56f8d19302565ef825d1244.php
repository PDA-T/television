<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/a.topv.club/application/app/view/index/wap_two.html";i:1581258926;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/public/static/v4/wap_two/swiper.min.css">
<link rel="stylesheet" href="/public/static/v4/wap_two/style.css">
<style>
    ...
    <div class="blog-slider__wrp swiper-wrapper">
        <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__img">
                <img src="<?php echo $app_wap_poster_one; ?>">
            </div>
            <div class="blog-slider__content">
                <span class="blog-slider__code">已有 <?php echo $app_wap_down_num; ?> 人下载</span>
                <div class="blog-slider__title"><?php echo $app_wap_title_one; ?></div>
                <div class="blog-slider__text"><?php echo $app_wap_subtitle_one; ?></div>
                <a  onclick="down()" class="blog-slider__button">立刻下载 <?php echo Ryan_name(); ?></a>
            </div>
        </div>

        <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__img">
                <img src="<?php echo $app_wap_poster_two; ?>">
            </div>
            <div class="blog-slider__content">
                <span class="blog-slider__code">已有 <?php echo $app_wap_down_num; ?> 人下载</span>
                <div class="blog-slider__title"><?php echo $app_wap_title_two; ?></div>
                <div class="blog-slider__text"><?php echo $app_wap_subtitle_two; ?></div>
                <a  onclick="down()" class="blog-slider__button">立刻下载 <?php echo Ryan_name(); ?></a>
            </div>
        </div>
        ...
        <div class="blog-slider__item swiper-slide">
            <div class="blog-slider__img">
                <img src="<?php echo $app_wap_poster_three; ?>">
            </div>
            <div class="blog-slider__content">
                <span class="blog-slider__code">已有 <?php echo $app_wap_down_num; ?> 人下载</span>
                <div class="blog-slider__title"><?php echo $app_wap_title_three; ?></div>
                <div class="blog-slider__text"><?php echo $app_wap_subtitle_three; ?></div>
                <a  onclick="down()" class="blog-slider__button">立刻下载 <?php echo Ryan_name(); ?></a>
            </div>
        </div>
    </div>
...
<script src="/public/static/v4/wap_two/swiper.min.js"></script>
<script src="/public/static/v4/wap_two/index.js"></script>
<script type="text/javascript">
