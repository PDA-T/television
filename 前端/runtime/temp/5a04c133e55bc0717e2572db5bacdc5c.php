<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/www/wwwroot/a.topv.club/application/index/view/skin/wap.html";i:1589188470;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
<div class="col-sm-12">
 ...
 <button class="mr-2 mb-2 btn btn-primary" data-target="#onboardingTextModal" data-toggle="modal" type="button" id="buttonid" style="display:none;">Modal with text only</button>
    ...
    <div class="user-profile compact">
        <br>
      <div align="center" >
      	<img src="https://i.loli.net/2020/05/11/z8dNlsH5EZqy4JG.png" class="img-responsive"  style="display: inline-block; height: auto; max-width: 100%;">
      ...
      <div class="up-controls">
        <div class="row">
          ...
          <div class="col-sm-6 text-right">
              ...
              <?php if($skin == 1){?>
              <div class="value badge badge-pill badge-success">  正在使用    </div>
              <?php } else{  ?>
              <a class="btn btn-primary btn-sm" href="<?php echo url('skin/wap'); ?>?skin_id=1&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>"><i class="os-icon os-icon-crown"></i>  切换 </a>
              <?php } ?>
                    ...
                    <div class="col-sm-2">
                        <div class="user-profile compact">
                            <br>
                            <div align="center" >
                                <img src="https://i.loli.net/2020/02/09/1uZtlvmpd5xVfB3.png" class="img-responsive"  style="display: inline-block; height: auto; max-width: 100%;">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
							          ...
							          <div class="col-sm-6 text-right">
							              ...
							              <div class="value badge badge-pill badge-success">  正在使用    </div>
							              <?php } else{  ?>
							              <a class="btn btn-primary btn-sm" href="<?php echo url('skin/wap'); ?>?skin_id=2&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>"><i class="os-icon os-icon-crown"></i>  切换 </a>
							              <?php } ?>
