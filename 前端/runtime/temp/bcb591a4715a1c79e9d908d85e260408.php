<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/a.topv.club/application/index/view/index/rakeback.html";i:1572730512;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('index/rakeback'); ?>" >
       ...
       <div aria-hidden="true" class="onboarding-modal modal fade animated" id="onboardingTextModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-centered" role="document">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 佣金最低提现额度</label><input class="form-control"  placeholder="Confirm Num" required="required" type="number"  value="<?php echo $vo['minimum_amount']; ?>" name="minimum_amount"  >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 一级返佣比例 %</label><input class="form-control"  placeholder="Confirm Num" required="required" type="number"    value="<?php echo $vo['agent_rebate_a']; ?>" name="agent_rebate_a"  >
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 二级返佣比例 %</label><input class="form-control"  placeholder="Confirm Num" required="required" type="number"    value="<?php echo $vo['agent_rebate_b']; ?>" name="agent_rebate_b" >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 三 级返佣比例 %</label><input class="form-control"  placeholder="Confirm Num" required="required" type="number"    value="<?php echo $vo['agent_rebate_c']; ?>" name="agent_rebate_c"  >
              </div>
            </div>
