<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/a.topv.club/application/index/view/artical/index.html";i:1576359336;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <div class="content-w">
          ...
          -------------------->
            ...
            <div class="content-box">
                    ...
                    <div class="element-box-tp">
                      <div class="table-responsive">
                        <table class="table table-padded">
                          ...
                          <tbody>
                            <?php if(is_array($artical_list) || $artical_list instanceof \think\Collection || $artical_list instanceof \think\Paginator): $i = 0; $__LIST__ = $artical_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>   
                            
                            <tr>
                              <td class="text-center">
                                <?php echo $vo['id']; if($vo['eject'] == 1){  ?>
                               <div class="value badge badge-pill badge-primary">弹窗</div>
                                <?php } ?>
                              ...
                              <td>
                                <div class="smaller lighter" style=" overflow: hidden; text-overflow:ellipsis; display:-webkit-box; -webkit-box-orient:vertical; -webkit-line-clamp: 1; ">
                                  <?php echo $vo['content']; ?>
                                </div>
                              </td>
                              <td>
                         			
                                <span class="badge badge-white-inverted" href=""><?php echo  date('Y年m月d日',$vo['time']); ?></span>
                              </td>
                              <td class="text-center">
                                
                                <?php if($vo['type'] == 0){  ?>
                                <span class="badge badge-light-inverted" href="">公告</span>
                                <?php }else if($vo['type'] == 1){  ?>
                                <span class="badge badge-dark-inverted" href="">电影推荐</span>
                                <?php } ?>

                              </td>
                              <td class="row-actions">
                                <a href="<?php echo url('artical/edit'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>"><i class="os-icon os-icon-pencil-1"></i></a>
              ...
              <div class="floated-chat-btn"  onclick="window.open('<?php echo url('artical/add'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">

                <span><i class="os-icon os-icon-pencil-1"></i><span>添加公告</span></span>
