<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/a.topv.club/application/index/view/live/live_special.html";i:1577921530;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-sm-12 col-xxxl-12">
                  <div class="element-wrapper">
                    <div class="element-actions d-none d-sm-block">
                      <a class="btn btn-primary btn-sm" href="<?php echo url('live/add_tv'); ?>"><i class="os-icon os-icon-edit-3"></i><span>新增</span></a>
                    </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <tbody>
                            <?php if(is_array($live_special) || $live_special instanceof \think\Collection || $live_special instanceof \think\Paginator): $i = 0; $__LIST__ = $live_special;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                            <tr onclick="window.open('<?php echo url('live/edit_tv'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">
                              
                              <td class="nowrap">
                                <span class="smaller "><?php echo $vo['id']; ?></span>
                                
                              </td>
                              <td class="nowrap">
                                <span class="smaller "><?php echo $vo['sort']; ?></span>
                                
                              </td>
                              
                              <td class="nowrap">
                                <span class="smaller "><?php echo $vo['name']; ?></span>

                              </td>
                              
                              <td class="nowrap">
                                <span class="smaller "><?php echo $vo['introduce']; ?></span>

                              </td>
                              
                              <td class="nowrap">
                                <span class="smaller "><?php echo $vo['state']; ?></span>
                              ...
                              <td  class="text-right">
                                <div class="cell-image-list">
                                  ...
                                  <div class="cell-img" style="background-image: url(<?php if(strpos($vo['picture'],'http://') !== false){  echo $vo['picture']; }else if(strpos($vo['picture'],'https://') !== false){  echo $vo['picture'];  }else{ echo input('server.REQUEST_SCHEME') . '://' . input('server.SERVER_NAME') . $vo['picture'] ; }  ?>)"></div>
