<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/www/wwwroot/a.topv.club/application/index/view/index/page_information.html";i:1573501582;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('index/page_information'); ?>" >
       ...
       <div aria-hidden="true" class="onboarding-modal modal fade animated" id="onboardingTextModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-centered" role="document">
         ...
         <div class="form-group">
            <label for=""> 副标题</label><input class="form-control" data-error="请输入副标题" placeholder="请输入副标题" value="<?php echo advert('50'); ?>"   name="app_index_subtitle" required="required" type="text">
          ...
          <fieldset class="form-group">
            <legend><span>PC Information</span></legend>
  
         <div class="form-group">
            <label for=""> LOGO</label><input class="form-control" data-error="请输入LOGO图片地址" placeholder="Enter Url" value="<?php echo advert('46'); ?>"   name="app_index_logo" required="required" type="text">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
          

			<div class="form-group">
            <label for=""> 简介</label><input class="form-control" data-error="请输入简介" placeholder="请输入简介"  type="text" value="<?php echo advert('31'); ?>"  name="app_index_content">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
			<div class="form-group">
            <label for=""> 右侧图片</label><input class="form-control" data-error="请输入首页右侧图片地址" placeholder="请输入首页右侧图片地址" required="required" type="text" value="<?php echo advert('32'); ?>"  name="app_index_img">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
          <div class="form-group">
            <label for=""> 固定</label><input class="form-control" data-error="请输入滚动关键词" placeholder="请输入滚动关键词" required="required" type="text" value="<?php echo advert('40'); ?>"  name="app_index_keywords">
            <div class="help-block form-text with-errors form-control-feedback">滚动关键词前的固定字符</div>
          </div>

            <div class="form-group">
              <label> 滚动显示关键词</label><textarea class="form-control" rows="2"   name="app_index_scrolling_keywords"><?php echo advert('33'); ?></textarea>
          ...
          <fieldset class="form-group">
            <legend><span>WAP Information</span></legend>
            

			<div class="form-group">
            <label for=""> LOGO</label><input class="form-control" data-error="请输入移动端LOGO地址" placeholder="Enter Url"  type="text" value="<?php echo advert('51'); ?>"  name="app_wap_logo">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>


			<div class="form-group">
            <label for=""> 手机模型背景</label><input class="form-control" data-error="请输入手机模型背景图片地址" placeholder="Enter Url"  type="text" value="<?php echo advert('52'); ?>"  name="app_wap_phone">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>


			<div class="form-group">
            <label for=""> 下载次数</label><input class="form-control" data-error="请输入下载次数" placeholder="Enter Num"  type="text" value="<?php echo advert('62'); ?>"  name="app_wap_down_num">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
           ...
           <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 海报 ①</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('53'); ?>"  name="app_wap_poster_one" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label > 背景 ①</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('63'); ?>"  name="app_wap_background_one" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >标题 ①</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('54'); ?>"  name="app_wap_title_one" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >小标题 ①</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('55'); ?>"  name="app_wap_subtitle_one" >
              </div>
            </div>
          </div>      
           ...
           <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 海报 ②</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('56'); ?>"  name="app_wap_poster_two" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label > 背景 ②</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('64'); ?>"  name="app_wap_background_two" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >标题 ②</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('57'); ?>"  name="app_wap_title_two" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >小标题 ②</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('58'); ?>"  name="app_wap_subtitle_two" >
              </div>
            </div>
          </div>      
           ...
           <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 海报 ③</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('59'); ?>"  name="app_wap_poster_three" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label > 背景 ③</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('65'); ?>"  name="app_wap_background_three" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >标题 ③</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('60'); ?>"  name="app_wap_title_three" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >小标题 ③</label><input class="form-control" placeholder="Confirm Title" required="required"  type="text"  value="<?php echo advert('61'); ?>"  name="app_wap_subtitle_three" >
              </div>
            </div>
          </div>      
