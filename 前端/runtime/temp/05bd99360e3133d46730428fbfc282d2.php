<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/a.topv.club/application/index/view/index/price.html";i:1575084280;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
         ...
         <div class="element-box-tp">
                  <div class="table-responsive">
                    <table class="table table-padded">
                      ...
                      <tbody>
                        <?php if(is_array($cdkey_type_list) || $cdkey_type_list instanceof \think\Collection || $cdkey_type_list instanceof \think\Paginator): $i = 0; $__LIST__ = $cdkey_type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cdkey_type_list): $mod = ($i % 2 );++$i;?>
                        <tr>
                          <td class="nowrap">
                            <span class="status-pill smaller yellow"></span><span><?php echo $cdkey_type_list['name']; ?></span>
                          </td>
                          <td>
                            <span class="smaller lighter"><?php echo $cdkey_type_list['content']; ?></span>
                          </td>
                          <td class="cell-with-media">
                            <span><?php echo $cdkey_type_list['gokaurl']; ?></span>
                          </td>
                          <td class="text-center">
                            <a class="badge badge-primary" href="<?php echo url('index/price_edit',['id'=>$cdkey_type_list['id']]); ?>" >编辑</a>
                            <a class="badge badge-danger" href="<?php echo url('index/price_del',['del_id'=>$cdkey_type_list['id'],'Ryan_key'=>$Ryan_key,'Ryan_time'=>$Ryan_time]); ?>" >删除</a>
                          </td>
                          <td class="text-right bolder nowrap">
                            <span class="text-success">¥ <?php echo $cdkey_type_list['cost_price']; ?></span>
                          </td>
                        </tr>
          ...
          <div class="form-buttons-w">
            ...
            <a class="btn btn-primary " href="<?php echo url('index/price_add'); ?>" > 新增</a>
          </div>
