<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/www/wwwroot/a.topv.club/application/index/view/video/hot.html";i:1573077728;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
            ...
            <div class="content-box">
              <div class="os-tabs-w">
                <div class="os-tabs-controls os-tabs-complex">
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a aria-expanded="false" class="nav-link active" data-toggle="tab"><span class="tab-label">热门推荐</span><span class="badge badge-success"><?php echo $video_hot_count; ?></span></a>
                    </li>

                    <li class="nav-item">
              			<div class="input-search-w" style=" margin-left: 20px; ">
                          <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('video/search_hot'); ?>" >
                    		<input class="form-control rounded bright" placeholder="检索影视..." type="search" name="search_video">
                            </form>
                 	 	</div>
                    </li>

                    <li class="nav-item nav-actions d-none d-sm-block">
                      <a class="btn btn-grey" href="<?php echo url('video/add_hot'); ?>"><i class="os-icon os-icon-plus-circle"></i><span>新 增</span></a>
                    </li> 
                  </ul>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="element-box-tp">
                     ...
                     <?php if(is_array($video_hot_list) || $video_hot_list instanceof \think\Collection || $video_hot_list instanceof \think\Paginator): $i = 0; $__LIST__ = $video_hot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                               
                          
                           <div class="col-12 col-sm-3 col-xxl-4">
                          <div class="post-box">
                            <div class="post-media" style="background-image: url(<?php echo $vo['img']; ?>)"></div>
                            <div class="post-content">
                              <h6 class="post-title">
                                <?php echo $vo['title']; ?>
                              </h6>
                              <div class="post-text" style=" overflow: hidden; text-overflow:ellipsis; display:-webkit-box; -webkit-box-orient:vertical; -webkit-line-clamp: 5; ">
                                <?php echo $vo['content']; ?>
                              </div>
                              <div class="post-foot">
                                <div class="post-tags">
                                ...
                                <a class="post-link"   href="<?php echo url('video/edit_hot'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>" target="_blank" ><span>编辑</span><i class="os-icon os-icon-pencil-1"></i></a>
                              </div>
                            </div>
                          </div>
                          </div>     
                   ...
                   <?php echo $video_hot_list->render(); ?>
                </div>
