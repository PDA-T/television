<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/a.topv.club/application/index/view/advertisement/check.html";i:1584101314;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" >
                            ...
                            <div class="value">
                             <?php echo $check_ok_count; ?>
                            </div>

                            <div class="trending trending-up-basic">
                            <span><?php echo $check_ok_count_proportion; ?> %</span><i class="os-icon os-icon-ui-02"></i>
                        ...
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" >
                            <div class="label" style="color: #e65252;">
                              待审核
                            </div>
                            <div class="value"  style="color: #e65252;">
                            <?php echo $check_wait_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                             <span><?php echo $check_wait_count_proportion; ?> %</span><i class="os-icon os-icon-grid-18"></i>
                            </div>
                          </a>
                        </div>
                        <div class="d-none d-xxxl-block col-xxxl-3">
                          <a class="element-box el-tablo" >
                            ...
                            <div class="value">
                             <?php echo $check_no_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                              <span><?php echo $check_no_count_proportion; ?> %</span><i class="os-icon os-icon-others-43"></i>
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <?php if(is_array($check_list) || $check_list instanceof \think\Collection || $check_list instanceof \think\Paginator): $i = 0; $__LIST__ = $check_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
