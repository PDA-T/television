<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/a.topv.club/application/index/view/live/add_tv.html";i:1577921090;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-sm-12 col-xxxl-12">
                  <div class="element-wrapper">
                    <h6 class="element-header">
                      ...
                      <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('live/add_tv'); ?>" >
			...
			<div class="row">
	              ...
	              <div class="col-sm-3">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Title" type="text" name="tv_name" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-3">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="mun" type="number" name="tv_sort" >
                  </div>        
            </div>             
              ...
              <div class="col-sm-3">
               	<div class="input-group">
                    ...
                    <select class="form-control"  name="tv_type">
              <option value="1" >
                TV直播
              </option>
              <option value="2" >
              ...
              <div class="col-sm-3">
               	<div class="input-group">
                    ...
                    <select class="form-control"    name="tv_state" >
              <option value="" >
                无
              </option>
              <option value="hot" >
            ...
            <br>
              ...
              <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Content" type="text" name="tv_introduce" >
                  </div>        
            </div>             
            ...
            <br>
              ...
              <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Picture" type="text" name="tv_picture"  >
                  </div>        
            </div>                   
            ...
            <br>
              ...
              <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Url" type="text" name="tv_live_url"  >
                  </div>        
            </div>                   
