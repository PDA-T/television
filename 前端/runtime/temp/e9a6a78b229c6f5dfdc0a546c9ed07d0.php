<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/a.topv.club/application/index/view/advertisement/ico_recommend.html";i:1584102180;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-sm-12">
                  <div class="element-wrapper">
                    ...
                    <h6 class="element-header">
                      推荐页小图标广告概况 <?php echo $type_name; ?>
                    </h6>
                    <div class="element-content">
                      <div class="row">
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/ico_recommend'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              ALL
                            </div>
                            <div class="value">
                              <?php echo $ico_recommend_count; ?>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/ico_recommend'); ?>?type=1&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              审核通过
                            </div>
                            <div class="value">
                              <?php echo $ico_recommend_ok_count; ?>
                            </div>
                            <div class="trending trending-up-basic">
                              <span><?php echo $ico_recommend_ok_count_proportion; ?> %</span><i class="os-icon os-icon-ui-02"></i>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/ico_recommend'); ?>?type=2&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              待审核
                            </div>
                            <div class="value">
                             <?php echo $ico_recommend_wait_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                             <span><?php echo $ico_recommend_wait_count_proportion; ?> %</span><i class="os-icon os-icon-grid-18"></i>
                            </div>
                          </a>
                        </div>
                        <div class="d-none d-xxxl-block col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/ico_recommend'); ?>?type=3&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              驳回
                            </div>
                            <div class="value">
                              <?php echo $ico_recommend_no_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                              <span><?php echo $ico_recommend_no_count_proportion; ?> %</span><i class="os-icon os-icon-others-43"></i>
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <?php if(is_array($ico_recommend_list) || $ico_recommend_list instanceof \think\Collection || $ico_recommend_list instanceof \think\Paginator): $i = 0; $__LIST__ = $ico_recommend_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                        ...
                        <?php echo $ico_recommend_list->render(); ?>
