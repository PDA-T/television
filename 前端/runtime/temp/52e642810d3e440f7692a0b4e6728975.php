<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/a.topv.club/application/index/view/appupgrade/android.html";i:1573133552;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="up-head-w" style="background-image:url(/public/static/v4/img/portfolio15.jpg)">
        ...
        <div class="up-main-info">
          ...
          <h6 class="up-sub-header">
            更新包地址： <?php if(empty(advert('24'))){ echo '<div class="value badge badge-pill badge-danger">未填写</div>'; } else { echo advert('24');} ?>
          </h6>
        </div>
      ...
      <div class="up-controls">
        <div class="row">
            ...
            <div class="value-pair">
              <div class="label">
                状态:
					...
					<?php if(advert('154') == '1'){ echo '<div class="value badge badge-pill badge-primary">推送中…</div>'; } else { echo '<div class="value badge badge-pill badge-danger">NO</div>';} ?>
          ...
          <div class="col-sm-6 text-right">
            ...
            <a class="btn btn-primary btn-sm"   href="<?php echo url('index/basic_information'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>" target="_blank" ><i class="os-icon os-icon-fingerprint"></i><span>修改更新包地址</span></a>
  ...
  <div class="col-sm-7">
    <div class="element-wrapper">
      <div class="element-box">
         <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('appupgrade/android'); ?>" >
          <div class="element-info">
            <div class="element-info-with-icon">
              ...
              <div class="element-info-text">
                ...
                <div class="element-inner-desc">
                  资料编辑.  <span id="timer" style=" margin-left: 10px; color: #999; font-size: 10px; "></span>
                </div>
              </div>
            </div>
          </div>
           ...
           <div class="row">
            <div class="col-sm-12">
             ...
             <label class="switch ">
               <input type="hidden"  name="Android_Updated_switch" value="0">
              <input type="checkbox" name="Android_Updated_switch" type="checkbox"  value="1"  <?php if(advert('154') ==1){echo 'checked';} ?> >
              <div class="slider"></div>
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="输入版本号" type="text" name="Android_Updated_version"  value="<?php echo advert('150'); ?>">
                  </div>
                </div>   
            ...
            <div class="form-group"><textarea class="form-control" placeholder="更新内容" rows="5"  name="Android_Updated_content"><?php echo advert('151'); ?></textarea></div>
