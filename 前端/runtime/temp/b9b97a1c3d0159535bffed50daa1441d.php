<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/a.topv.club/application/index/view/poster/edit.html";i:1574100334;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
  ...
  <div class="col-sm-5">
	...
	<div class="up-head-w" style="height: 750px; background-image:url(<?php echo $poster_data['img']; ?>)" >
              <div class="up-social">
  ...
  <div class="col-sm-7">
    <div class="element-wrapper">
      <div class="element-box">
         <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('poster/edit'); ?>" >
            ...
            <div class="element-info-with-icon">
              ...
              <div class="element-info-text">
                ...
                <div class="element-inner-desc">
                   <span id="timer" style=" margin-left: 10px; color: #999; font-size: 10px; "></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="poster_name" value="<?php echo $poster_data['name']; ?>">
                  </div>             
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="poster_img" value="<?php echo $poster_data['img']; ?>">
                  </div>             
          ...
          <div class="form-buttons-w">
            ...
            <input type="hidden" name="edit_id"  id="edit_id"  value="<?php echo $poster_data['id']; ?>" >
            ...
            <span class="btn btn-danger "  onclick="window.open(' <?php echo url('poster/del'); ?>?del_id=<?php echo $poster_data['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')"  style=" float: right; "> 删除</span>
...
<img id="image" src="<?php echo $poster_data['img']; ?>" style="display:none;" width="1" height="1" />
<script>
