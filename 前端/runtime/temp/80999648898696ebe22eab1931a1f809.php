<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/app.qukan.im/application/index/view/index/appKey.html";i:1574005140;s:60:"/www/wwwroot/app.qukan.im/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="auth-box-w wider centered">
        ...
        <div class="logged-user-w">
          ...
          <div class="logged-user-role">
            	...
            	更换：服务器环境、运行环境、域名等 授权将会失效;防止泄漏滥用！ <br>
           授权失效后 后台90%操作禁止，前端禁止登录、注册和使用激活码！<br>
           <br>
           
           
          </div>
        </div>
       <form class="form-material"    role="form" id="form1" method="post" action="<?php echo url('index/appKey'); ?>">
          
          <div class="form-group">
            <input type="text" class="form-control"   value="授权ID: <?php echo advert('47'); ?>"  data-validate="required,minlength[4],maxlength[18]" disabled="disabled">
          ...
          <div class="form-group">
            <input type="text" class="form-control"   value="识别码: <?php echo authorization(); ?>"  disabled="disabled">
          </div>
         
         
            <div class="form-group">
              <textarea class="form-control" rows="5"   name="appKey"><?php echo advert('48'); ?></textarea>
              <div class="help-block form-text with-errors form-control-feedback">请输入授权码</div>
