<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/a.topv.club/application/index/view/index/basic_information.html";i:1583943994;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('index/basic_information'); ?>" >
 ...
 <button class="mr-2 mb-2 btn btn-primary" data-target="#onboardingTextModal" data-toggle="modal" type="button" id="buttonid" style="display:none;">Modal with text only</button>
       ...
       <div aria-hidden="true" class="onboarding-modal modal fade animated" id="onboardingTextModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-centered" role="document">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > APP名称</label><input class="form-control"  placeholder="Confirm Name" required="required" type="text"  value="<?php echo advert('21'); ?>"  name="app_name" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >域名</label><input class="form-control" placeholder="Confirm Domain Name" required="required" type="text"  value="<?php echo advert('30'); ?>"  name="domain_name" >
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 积分兑换会员</label><input class="form-control"  placeholder="Confirm Integral" required="required" type="number"  value="<?php echo advert('4'); ?>"  name="sign" >
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="">体验时间</label><input class="form-control"  placeholder="Confirm Time" required="required" type="number"   value="<?php echo advert('5'); ?>"  name="time" >
               <!--<div class="help-block form-text with-errors form-control-feedback">124</div>-->
                   <div class="help-block form-text text-muted form-control-feedback"> 注册会员后默认赠送的会员时间 单位：分钟</div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
             ...
             <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="number" name="sign_down" value="<?php echo advert('2'); ?>">
                  </div>
            </div>
            <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="number" name="sign_pass" value="<?php echo advert('3'); ?>">
                  </div>
            </div>
          </div>   
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 邀请赠送积分</label><input class="form-control"  placeholder="Confirm Integral" required="required" type="number"  value="<?php echo advert('34'); ?>"  name="Invitation_points" >
                <div class="help-block form-text text-muted form-control-feedback">
                  邀请一个有效用户 赠送积分数
                </div>
              </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="">首页推荐视频调用数量</label><input class="form-control"  placeholder="Confirm Num" required="required" type="number"   value="<?php echo advert('45'); ?>"  name="index_video_num" >
               <!--<div class="help-block form-text with-errors form-control-feedback">124</div>-->
                   <div class="help-block form-text text-muted form-control-feedback"> 尽量为3的倍数 不宜太高</div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 客服微信 </label><input class="form-control"  placeholder="Confirm WeChat" required="required" type="text"  value="<?php echo $wechat; ?>"  name="wechat" >
                <div class="help-block form-text text-muted form-control-feedback">
                  代理也可以设置客服微信，APP中代理未设置时显示管理员的，代理设置后显示代理的；<br>所有代理都显示管理员的；
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="">升级代理赠送体验金额</label><input class="form-control"  placeholder="Confirm Money" required="required" type="number"   value="<?php echo advert('20'); ?>"  name="agent_default_money" >
               <!--<div class="help-block form-text with-errors form-control-feedback">124</div>-->
                   <div class="help-block form-text text-muted form-control-feedback"> 赠送金额不可提现 （ 仅允许佣金提现 ）</div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 单点登录 / 封号（*10）检测频率（毫秒） </label><input class="form-control"  placeholder="Confirm Mumber" required="required" type="number"  value="<?php echo advert('66'); ?>"  name="SingleSignOnRate" >
                   <div class="help-block form-text text-muted form-control-feedback"> 最低1分钟 也就是60000毫秒，低于1分钟按1分钟计算</div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口安全阈值 (基础安全规则)</label><input class="form-control"  placeholder="Confirm Num" required="required" type="text"  value="<?php echo advert('68'); ?>"  name="safety_threshold" >
                <div class="help-block form-text text-muted form-control-feedback">  大于30 小于43200 ; APP频繁出现Key验证失败 可以略微调高!（ 过高时请开启安全防护 ）</div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 代理管理PC端检索激活码请求频率 (每小时) </label><input class="form-control"  placeholder="Confirm Mumber" required="required" type="number"  value="<?php echo advert('126'); ?>"  name="cdkey_search_frequency" >
                   <div class="help-block form-text text-muted form-control-feedback"> 设置过高可能带来未知安全风险 </div>
              </div>
            </div>
           ...
           <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label > 邀请广告语 </label><input class="form-control"  placeholder="Confirm AD" required="required" type="text"  value="<?php echo advert('67'); ?>"  name="advertising_slogan" >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="connection_failed_tips" value="<?php echo advert('83'); ?>">
                  </div>        
            </div>     
          </div>
            -->
          ...
          <div class="row">
            <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="DefaultLogo" value="<?php echo advert('114'); ?>">
                  </div>        
            </div>     
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="User_AgentIntroductionBanner" value="<?php echo advert('115'); ?>">
                  </div>        
            </div>   
          </div>    
          ...
          <div class="row">
            <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="agent_introduction_picture" value="<?php echo advert('111'); ?>">
                  </div>        
            </div>     
          </div>
            ...
            <div class="col-sm-12">
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="Sm_Authorization" value="<?php echo advert('35'); ?>">
                  </div>        
            </div>     
          </div>
          ...
          <fieldset class="form-group">
            <legend><span>Site Information</span></legend>
            

			<div class="form-group">
            <label for=""> Ios 下载地址</label><input class="form-control" data-error="请输入下载地址" placeholder="Enter Url"  type="text" value="<?php echo advert('22'); ?>"  name="app_ios_down">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
			<div class="form-group">
            <label for=""> Android 下载地址</label><input class="form-control" data-error="请输入下载地址" placeholder="Enter Url" required="required" type="text" value="<?php echo advert('23'); ?>"  name="app_android_down">
            <div class="help-block form-text with-errors form-control-feedback"></div>
          </div>
          <div class="form-group">
            <label for=""> Android Apk 地址</label><input class="form-control" data-error="请输入APK文件下载地址" placeholder="Enter Url" required="required" type="text" value="<?php echo advert('24'); ?>"  name="app_android_apk_down">
            <div class="help-block form-text with-errors form-control-feedback">用于APP更新</div>
          </div>
       ...
       <div class="form-group">
            ...
            <div class="form-group">
              <label> 搜索推荐关键词</label><textarea class="form-control" rows="3"   name="Hot_search"><?php echo advert('300'); ?></textarea>
              <div class="help-block form-text with-errors form-control-feedback">多个关键词用 , 隔开</div>
            </div>

              <!--
            <div class="form-group">
              <label> 特权影视区域调用X5</label><textarea class="form-control" rows="3"  name="tencent_x5"><?php echo advert('121'); ?></textarea>
              <div class="help-block form-text with-errors form-control-feedback">多个域名用 , 隔开</div>
            </div>
              -->

              <div class="form-group">
                  <label> 代理公告内容：（PC管理后台/APP代理中心）</label><textarea class="form-control" rows="3"  name="agent_bulletin"><?php echo advert('44'); ?></textarea>
              </div>
            
            <div class="form-group">
              <label> 免责声明</label><textarea class="form-control" rows="3"  name="exemption_from_declaration"><?php echo advert('112'); ?></textarea>
              <div class="help-block form-text with-errors form-control-feedback">会员中心显示</div>
            </div>
          ...
          <div class="form-buttons-w">
            ...
            <button class="btn btn-primary disabled" type="submit"> 确认</button><span id="timer" style=" margin-left: 10px; color: #999; font-size: 10px; "></span>
          </div>
        </form>
      </div>
    </div>
