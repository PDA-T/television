<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/a.topv.club/application/index/view/payment/index.html";i:1577846788;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <div class="content-w">
          ...
          -------------------->
            ...
            <div class="content-box">
                    ...
                    <div class="element-box-tp">
                      <div class="table-responsive">
                        <table class="table table-padded">
                          ...
                          <tbody>
                            <?php if(is_array($payment_log) || $payment_log instanceof \think\Collection || $payment_log instanceof \think\Paginator): $i = 0; $__LIST__ = $payment_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>  
                            <tr>
                              ...
                              <td>
                                <div class="user-with-avatar">
                                  <span class="smaller lighter" > UID:<?php echo $vo['uid']; ?></span>
                                  <span class="smaller lighter" > <?php echo $vo['username']; ?></span>
                                </div>
                              </td>
                              <td>
                              ...
                              <td class="text-center">
                                <div class="value badge badge-pill badge-primary">¥ <?php echo $vo['total_amount']; ?> / <?php echo $vo['receipt_amount']; ?> </div>
                              </td>
                              <td class="text-center">
                                <div class="smaller lighter"><?php echo $vo['out_trade_no']; ?> </div>
                              </td>
                              <td class="text-center">
                                <div class="smaller lighter"><?php echo $vo['trade_no']; ?> </div>
                              </td>
                              <td class="text-center">
                                <div class="smaller lighter"> <?php echo $vo['buyer_logon_id']; ?> </div>
                              </td>
                              <td class="nowrap">
                                                            
                            <?php  if($vo['trade_status']=='WAIT_BUYER_PAY') {  ?>
                            	 <div class="status-pill red" data-title="待支付" data-toggle="tooltip" ></div>
                                <span  class="smaller lighter">待支付</span>
                            <?php }else if($vo['trade_status']=='TRADE_SUCCESS') {   ?>
                           		 <div class="status-pill green" data-title="已支付" data-toggle="tooltip" ></div>
                                <span  class="smaller lighter">已支付</span>
                            <?php } ?>
                                
                              </td>
                              <td class="row-actions">
                                <span class="smaller lighter" ><?php echo $vo['gmt_create']; ?> </span>
                              </td>
                              <td>
                                <span class="smaller lighter"><?php echo $vo['gmt_payment']; ?></span>
                              </td>
                            </tr>
              ...
              <div class="floated-chat-btn" onclick="window.location.href = '<?php echo url('payment/search'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>'">

                <span><i class="os-icon os-icon-wallet-loaded"></i><span>订单检索</span></span>
