<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/a.topv.club/application/index/view/rebate/index.html";i:1573158294;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                    ...
                    <div class="element-box-tp">
                      <div class="table-responsive">
                        <table class="table table-padded">
                          ...
                          <tbody>
                            <?php if(is_array($cash_out_list) || $cash_out_list instanceof \think\Collection || $cash_out_list instanceof \think\Paginator): $i = 0; $__LIST__ = $cash_out_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>  
                            <tr>
                              ...
                              <td>
                                <div class="user-with-avatar">
                                  <img alt="" src="/public/static/v4/img/Ryan.png"><span><?php echo $vo['username']; ?></span>
                                </div>
                              </td>
                              <td>
                                <div class="smaller lighter">
                                 <?php echo $vo['zfb']; ?>  <div class="cell-img-more"> <?php echo $vo['zfb_name']; ?> </div>
                                </div>
                              </td>
                              <td>
                                <span class="smaller lighter"><?php echo $vo['weichat']; ?></span>
                              </td>
                              <td class="text-center">
                                <div class="value badge badge-pill badge-primary">¥ <?php echo $vo['txje']; ?> </div>
                              </td>
                              <td class="nowrap">
                                                            
                            <?php  if($vo['status']=='1') {  ?>
                            	 <div class="status-pill green" data-title="正常" data-toggle="tooltip" ></div>
                                <span  class="smaller lighter">正常</span>
                            <?php }else{  ?>
                           		 <div class="status-pill red" data-title="已禁封" data-toggle="tooltip" ></div>
                                <span  class="smaller lighter">已禁封</span>
                            <?php }  ?>
                                
                              </td>
                              <td class="row-actions">
                                <a class="primary" href="<?php echo url('rebate/cash_application'); ?>?application_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>"><i class="os-icon os-icon-wallet-loaded"></i></a>
                              </td>
                            </tr>
