<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/www/wwwroot/a.topv.club/application/app/view/index/index_v4.html";i:1573633070;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="<?php echo $app_index_subtitle; ?>">
    <title><?php echo Ryan_name(); ?> - <?php echo $app_index_subtitle; ?></title>
    <link href="/public/static/v4/index/bootstrap.css" rel="stylesheet">
	<link href="/public/static/v4/index/styles.css" rel="stylesheet">
    <link rel="icon" href="favicon.png">    
  
  <script type="text/javascript">
if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i))) {
		window.location.href = "/app/index/wap";
}
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        <a class="navbar-brand logo-image" href="index.html"><img src="<?php echo $app_index_logo; ?>" alt="PNS"></a> 
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll">Perfect Network Service</a>
                </li>
            </ul>
        </div>
    </nav> 
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright &copy; 2019.Company name All rights reserved.<a><?php echo Ryan_name(); ?></a></p>
                </div> 
            </div>
        </div> 
    </div> 
    <script src="/public/static/v4/index/jquery.min.js"></script> 
    <script src="/public/static/v4/index/morphext.min.js"></script> 
    <script src="/public/static/v4/index/scripts.js"></script> 
</body>
</html>