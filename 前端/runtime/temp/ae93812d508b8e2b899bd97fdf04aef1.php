<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/www/wwwroot/a.topv.club/application/index/view/faqs/add.html";i:1573336100;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
         <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('faqs/add'); ?>" >
          <div class="element-info">
              ...
              <div class="element-info-text">
                ...
                <div class="element-inner-desc">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="输入标题" type="text" name="question" >
                  </div>
                </div>        
            ...
            <div class="form-group"><textarea class="form-control"  placeholder="简介" rows="10"  name="answer" ></textarea></div>
