<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/a.topv.club/application/index/view/index/appId.html";i:1572644772;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
      ...
      <div class="auth-box-w wider centered">
       ...
       <form class="form-material"    role="form" id="form1" method="post" action="<?php echo url('index/appId'); ?>">
          <div class="form-group">
            <label for="">请输入 APPID 勿随意修改</label>
            <input type="text" class="form-control"   value="<?php echo advert('47'); ?>" name="appId" data-validate="required,minlength[4],maxlength[18]" placeholder="A************">
