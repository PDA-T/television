<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/www/wwwroot/a.topv.club/application/index/view/index/smtp.html";i:1572730522;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('index/smtp'); ?>" >
       ...
       <div aria-hidden="true" class="onboarding-modal modal fade animated" id="onboardingTextModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-centered" role="document">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > SMTP发件服务器地址</label><input class="form-control"  placeholder="Confirm Server" required="required" type="text"  value="<?php echo advert('370'); ?>" name="Simple_Mail_Transfer_Protocol_server"  >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 端口号</label><input class="form-control"  placeholder="Confirm Port" required="required" type="number"  value="<?php echo advert('371'); ?>" name="Simple_Mail_Transfer_Protocol_port" >
                <div class="help-block form-text text-muted form-control-feedback">
                  常见端口：25 、465、587、995、110 根据自己的需求选择
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 账户</label><input class="form-control"  placeholder="Confirm Name" required="required" type="text"  value="<?php echo advert('372'); ?>" name="Simple_Mail_Transfer_Protocol_username" >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 密码/授权码</label><input class="form-control"  placeholder="Confirm Num" required="required" type="password"  value="<?php echo advert('373'); ?>" name="Simple_Mail_Transfer_Protocol_password" >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 发件人名称 </label><input class="form-control"  placeholder="Confirm Num" required="required" type="text"  value="<?php echo advert('374'); ?>" name="Simple_Mail_Transfer_Protocol_name" >
                <div class="help-block form-text text-muted form-control-feedback">
                  尽量不要带敏感字眼 以免被拦截或进垃圾箱
                </div>
              </div>
            </div>
