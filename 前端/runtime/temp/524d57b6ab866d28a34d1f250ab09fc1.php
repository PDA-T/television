<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/a.topv.club/application/index/view/index/interface.html";i:1590994268;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('index/interface'); ?>" >
       ...
       <div aria-hidden="true" class="onboarding-modal modal fade animated" id="onboardingTextModal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-centered" role="document">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口一</label><input class="form-control"  placeholder="Confirm Url" required="required" type="text"  value="<?php echo advert('8'); ?>"  name="interface_one" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >接口二</label><input class="form-control" placeholder="Confirm Url" type="text"  value="<?php echo advert('9'); ?>"  name="interface_two" >
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口三</label><input class="form-control"  placeholder="Confirm Url" type="text"  value="<?php echo advert('10'); ?>"  name="interface_three" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="">接口四</label><input class="form-control"  placeholder="Confirm Url"  type="text"   value="<?php echo advert('11'); ?>"  name="interface_four" >
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口五</label><input class="form-control"  placeholder="Confirm Url"  type="text"  value="<?php echo advert('12'); ?>"  name="interface_five" >
              </div>
            </div>               
            ...
            <legend><span>独立解析接口 for IOS</span></legend>
	        ...
	        <div class="row">		
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    <select class="form-control"   value="advert('1500')"  name="Ios_alone_interface_switch" id="status">
              <option value="1" <?php if(advert('1500') ==1){echo 'selected';} ?>>
                启用
              </option>
              <option value="0" <?php if(advert('1500') ==0){echo 'selected';} ?>>
                关闭
              </option>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口一  </label><input class="form-control"  placeholder="Confirm Url" type="text"  value="<?php echo advert('1501'); ?>"  name="jx_ios_Interface_one" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label >接口二  </label><input class="form-control" placeholder="Confirm Url" type="text"  value="<?php echo advert('1502'); ?>"  name="jx_ios_Interface_two" >
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口三 </label><input class="form-control"  placeholder="Confirm Url" type="text"  value="<?php echo advert('1503'); ?>"  name="jx_ios_Interface_three" >
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="">接口四  </label><input class="form-control"  placeholder="Confirm Url"  type="text"   value="<?php echo advert('1504'); ?>"  name="jx_ios_Interface_four" >
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label > 接口五  </label><input class="form-control"  placeholder="Confirm Url"  type="text"  value="<?php echo advert('1505'); ?>"  name="jx_ios_Interface_five" >
              </div>
            </div>
          ...
          <fieldset class="form-group">
            <legend><span>苹果CMS地址 (需要http://或者https://)</span></legend>
            
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                <input class="form-control"  placeholder="Confirm Url"  type="text"  value="<?php echo advert('113'); ?>"  name="search_api_url" >
              </div>
            </div>
           ...
           <fieldset class="form-group">
            <legend><span>JSON / API 接口</span></legend>
          ...
          <div class="row">
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    <select class="form-control"   value="advert('80')"  name="interface_type_opt">
              <option value="1" <?php if(advert('80') ==1){echo 'selected';} ?>>
                启用
              </option>
              <option value="0" <?php if(advert('80') ==0){echo 'selected';} ?>>
                关闭
              </option>
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    <select class="form-control"   value="advert('310')"  name="interface_json_opt">
              <option value="1" <?php if(advert('301') ==1){echo 'selected';} ?>>
                接口 ①
              </option>
              <option value="2" <?php if(advert('301') ==2){echo 'selected';} ?>>
                接口 ②
              </option>
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Uid"  type="text"  value="<?php echo advert('13'); ?>"  name="interface_json_one_id" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo advert('14'); ?>"  name="interface_json_one_token" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Uid"  type="text"  value="<?php echo advert('15'); ?>"  name="interface_json_two_id" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo advert('16'); ?>"  name="interface_json_two_token" >
                  </div>        
            </div>        
           ...
           <fieldset class="form-group">
            ...
            <legend><span> START PLAY DECISION </span></legend>
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['iqy']; ?>"  name="iqy_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['tx']; ?>"  name="tx_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['yk']; ?>"  name="yk_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['sohu']; ?>"  name="sohu_play_decide" >
                  </div>        
            </div>        
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['ls']; ?>"  name="leshi_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['m1905']; ?>"  name="m1905_play_decide" >
                  </div>        
            </div>        
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['mg']; ?>"  name="mg_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['migu']; ?>"  name="migu_play_decide" >
                  </div>        
            </div>        
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Uid"  type="text"  value="<?php echo $play_decide['pptv']; ?>"  name="pptv_play_decide" >
                  </div>        
            </div>                   
              ...
              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Confirm Key"  type="text"  value="<?php echo $play_decide['fx']; ?>"  name="fx_play_decide" >
                  </div>        
            </div>        
