<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/a.topv.club/application/index/view/cdkey/usage_log.html";i:1572903380;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                  ...
                  <div class="table-responsive">
                    <table class="table table-padded">
                      ...
                      <tbody>
                        ...
                        <?php if(is_array($cdkey_use_list) || $cdkey_use_list instanceof \think\Collection || $cdkey_use_list instanceof \think\Paginator): $i = 0; $__LIST__ = $cdkey_use_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
                        
                        <tr onclick="window.open('search?cdkey=<?php echo $vo['cdkey']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">
                          <td>
                            <span><?php echo  date('Y-m-d',$vo['stime']); ?></span><span class="smaller lighter"><?php echo  date('H:i:s',$vo['stime']); ?></span>
                          </td>
                          <td class="cell-with-media">
                            <span><?php echo $vo['cdkey']; ?></span>
                          </td>
                          <td class="text-center">
                            <a class="badge badge-secondary" href=""><?php echo $vo['yid']; ?></a>
                          </td>
                          <td class="text-center">
                            <a class="badge badge-primary" href=""><?php echo $vo['uid']; ?></a>
                          </td>
                          <td class="text-right bolder nowrap">
                            <span class="text-primary"><?php echo $vo['name']; ?></span>
                          </td>
                        </tr>
                    ...
                    <?php echo $cdkey_use_list->render(); ?>
                  </div>
                </div>
              </div>
