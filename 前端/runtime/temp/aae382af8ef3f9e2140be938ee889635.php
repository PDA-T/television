<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"/www/wwwroot/a.topv.club/application/index/view/poster/index.html";i:1574098494;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <div class="content-w">
          ...
          -------------------->
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <?php if(is_array($poster_list) || $poster_list instanceof \think\Collection || $poster_list instanceof \think\Paginator): $i = 0; $__LIST__ = $poster_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    

                            
                           
                            <tr  onclick="window.open(' <?php echo url('poster/edit'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">
                              <td class="nowrap">
                                <?php echo $vo['name']; ?>
                              </td>
                              <td  class="text-center">
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(<?php echo $vo['img']; ?>)"></div>
            ...
            <div class="content-panel">
              ...
              <div class="floated-chat-btn"  onclick="window.location.href = '<?php echo url('poster/add'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>'"  style="cursor:pointer">

                <span><i class="os-icon os-icon-pencil-1"></i><span>添加海报</span></span>
