<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/a.topv.club/application/index/view/advertisement/edit.html";i:1573242872;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
  ...
  <div class="col-sm-5">
	...
	<div class="up-head-w" style="background-image:url(<?php echo $ad_data['picurl']; ?>)">
              <div class="up-social">
          
                    <a href="#" class="">
                      <i class="os-icon os-icon-mail-07 up-sub-header"  data-title="当前图片高宽" data-toggle="tooltip" id="natural"> 0</i> 
                </a>
  ...
  <div class="col-sm-7">
    <div class="element-wrapper">
      <div class="element-box">
         <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('advertisement/edit'); ?>" >
            ...
            <div class="element-info-with-icon">
              ...
              <div class="element-info-text">
                ...
                <div class="element-inner-desc">
                  用户广告资料审核.  <span id="timer" style=" margin-left: 10px; color: #999; font-size: 10px; "></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $user_data['phone']; ?>" disabled="disabled">
                  </div>             
            ...
            <div class="col-sm-6">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $user_data['weichat']; ?>" disabled="disabled">
                  </div>             
          ...
          <div class="row">
            <div class="col-sm-12">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $user_data['email']; ?>" disabled="disabled">
                  </div>             
          ...
          <fieldset class="form-group">
            <legend><span>广告审核处理</span></legend>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $ad_data['name']; ?>" disabled="disabled">
                  </div>             
            ...
            <div class="col-sm-12">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo $ad_data['linkurl']; ?>" disabled="disabled">
                  </div>             
          ...
          <div class="row">
            <div class="col-sm-6">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text"  value="<?php if($ad_data['cid'] == '100'){echo '首页轮播';}else if($ad_data['cid'] == '1'){echo '推荐页轮播';}else if($ad_data['cid'] =='2'){echo '推荐页图标';}else if($ad_data['cid'] == '3'){echo '推荐页横幅';} ?>" disabled="disabled">
                  </div>             
                ...
                <div class="form-group ">
                  ...
                  <?php if($ad_data['audit'] == '3'){ ?>
                      <input class="form-control" type="text"  value="已驳回" disabled="disabled">
				  <?php }else if($ad_data['audit'] == '1'){ ?>
                    <select class="form-control"  name="ad_audit" id="ad_audit">
                        <option value="1" selected>已审核通过</option>
                  ...
                  <?php if($ad_data['audit'] == '3'){ ?>
           			 <div class="form-group"  ><textarea class="form-control" placeholder="拒绝原因" rows="5" disabled="disabled">驳回原因： <?php echo $ad_data['content']; ?> </textarea></div>     
                  <?php } ?>

                
      		
            <div class="form-group" id="ad_content" ><textarea class="form-control" placeholder="拒绝原因" rows="5"  name="ad_content"></textarea></div>      
          ...
          <div class="form-buttons-w">
            ...
            <input type="hidden" name="edit_id"  id="edit_id"  value="<?php echo $ad_data['id']; ?>" >

            
          <?php if($ad_data['audit'] == '3'){ ?>
            <span class="btn btn-danger disabled"  onclick="window.open(' <?php echo url('advertisement/del'); ?>?del_id=<?php echo $ad_data['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" > 删除</span>
		  <?php }else{ ?>  
...
<img id="image" src="<?php echo $ad_data['picurl']; ?>" style="display:none;" width="1" height="1" />
<script>
			window.onload = function(){
				var image = document.getElementById("image");
              	document.getElementById("natural").innerHTML = "当前上传图片 高："+ image.naturalHeight + "px 宽："+ image.naturalWidth+ "px ";
				//alert("原始宽度："+image.naturalWidth);
				//alert("原始高度:"+image.naturalHeight);
