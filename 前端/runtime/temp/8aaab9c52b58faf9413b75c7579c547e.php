<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/a.topv.club/application/index/view/video/privilege.html";i:1574304616;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-sm-12 col-xxxl-6">
                  <div class="element-wrapper">
                    <div class="element-actions d-none d-sm-block">
                      <a class="btn btn-primary btn-sm" href="<?php echo url('video/add_privilege'); ?>"><i class="os-icon os-icon-edit-3"></i><span>新增</span></a>
                    </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <tbody>
                            <?php if(is_array($privilege_list) || $privilege_list instanceof \think\Collection || $privilege_list instanceof \think\Paginator): $i = 0; $__LIST__ = $privilege_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                            <tr onclick="window.open('<?php echo url('video/edit_privilege'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">
                              ...
                              <td  class="text-right">
                                <div class="cell-image-list">
                                  ...
                                  <div class="cell-img" style="background-image: url(<?php if(strpos($vo['picurl'],'http://') !== false){  echo $vo['picurl']; }else if(strpos($vo['picurl'],'https://') !== false){  echo $vo['picurl'];  }else{ echo input('server.REQUEST_SCHEME') . '://' . input('server.SERVER_NAME') . $vo['picurl'] ; }  ?>)"></div>
            ...
            <div class="content-panel">
              ...
              <div class="element-wrapper">
                ...
                <div class="element-box-tp">
                  ...
                  <div class="el-buttons-list full-width">
                    <span class="btn btn-danger btn-sm"><i class="os-icon os-icon-delivery-box-2"></i><span>
                    <?php if(advert('301') !== '1'){ echo '当前正在使用：内置 ② '; }else{ echo '当前使用：内置 ①'; } ?>
                      </span></span>
                  </div>
                </div>
              </div>
