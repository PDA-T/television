<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/a.topv.club/application/index/view/live/setup_tv.html";i:1578098602;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
        ...
        <div class="content-w">
                ...
                <div class="col-sm-12 col-xxxl-12">
                  <div class="element-wrapper">
                    <h6 class="element-header">
                      ...
                      <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('live/setup_tv'); ?>" >
  
                 <!--   <div class="profile-tile">
                      <a class="profile-tile-box">
                        <div class="pt-avatar-w">
                          <img alt="" src="<?php if(strpos(advert('2000'),'http://') !== false){  echo advert('2000'); }else if(strpos(advert('2000'),'https://') !== false){  echo advert('2000');  }else{ echo input('server.REQUEST_SCHEME') . '://' . input('server.SERVER_NAME') . advert('2000') ; }  ?>">
                        </div>
                      </a>
          ...
          <fieldset class="form-group">
            <legend><span>首页 - 个性化</span></legend>
			...
			<div class="row">
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Title" type="text" name="live_text" value="<?php echo advert('2001'); ?>" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Title" type="text" name="live_button"  value="<?php echo advert('2002'); ?>" >
                  </div>        
            </div>             
          ...
          <fieldset class="form-group">
            <legend><span>直播 - 广告设置</span></legend>
                         
              <div class="onboarding-text" style=" color: #9E9E9E; ">
                建议尺寸：高度 466px  宽度 364px
              </div>
			...
			<div class="row">
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Img Url" type="text" name="live_left_upper_img" value="<?php echo advert('2003'); ?>" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Url" type="text" name="live_left_upper_url"  value="<?php echo advert('2004'); ?>" >
                  </div>        
            </div>             
			...
			<div class="row">
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Img Url" type="text" name="live_right_upper_img" value="<?php echo advert('2005'); ?>" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Url" type="text" name="live_right_upper_url"  value="<?php echo advert('2006'); ?>" >
                  </div>        
            </div>             
			...
			<div class="row">
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Img Url" type="text" name="live_right_lower_img" value="<?php echo advert('2007'); ?>" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Url" type="text" name="live_right_lower_url"  value="<?php echo advert('2008'); ?>" >
                  </div>        
            </div>             
			...
			<div class="row">
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Img Url" type="text" name="live_benner_img" value="<?php echo advert('2009'); ?>" >
                  </div>        
            </div>             
	              ...
	              <div class="col-sm-6">
               	<div class="input-group">
                    ...
                    </div><input class="form-control"  placeholder="Url" type="text" name="live_benner_url"  value="<?php echo advert('2010'); ?>" >
                  </div>        
            </div>             
