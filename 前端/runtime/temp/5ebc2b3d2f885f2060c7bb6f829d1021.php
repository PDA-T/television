<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/www/wwwroot/a.topv.club/application/index/view/faqs/index.html";i:1573334264;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <div class="content-w">
          ...
          -------------------->
            ...
            <div class="content-box">
                    ...
                    <div class="element-box-tp">
                      <div class="table-responsive">
                        <table class="table table-padded">
                          ...
                          <tbody>
                            <?php if(is_array($faq_list) || $faq_list instanceof \think\Collection || $faq_list instanceof \think\Paginator): $i = 0; $__LIST__ = $faq_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>   
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="user-with-avatar">
                                 <span><?php echo $vo['question']; ?></span>
                                </div>
                              </td>


                              <td class="row-actions">
                                <a href="<?php echo url('faqs/edit'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>"><i class="os-icon os-icon-pencil-1"></i></a>
              ...
              <div class="floated-chat-btn"  onclick="window.open('<?php echo url('faqs/add'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">

                <span><i class="os-icon os-icon-pencil-1"></i><span>添加</span></span>
