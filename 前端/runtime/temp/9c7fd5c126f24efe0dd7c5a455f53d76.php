<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/a.topv.club/application/index/view/advertisement/banner_index.html";i:1584101832;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-sm-12">
                  <div class="element-wrapper">
                    ...
                    <h6 class="element-header">
                      首页轮播广告概况 <?php echo $type_name; ?>
                    </h6>
                    <div class="element-content">
                      <div class="row">
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/banner_index'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              ALL
                            </div>
                            <div class="value">
                              <?php echo $banner_index_count; ?>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/banner_index'); ?>?type=1&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              审核通过
                            </div>
                            <div class="value">
                              <?php echo $banner_index_ok_count; ?>
                            </div>
                            <div class="trending trending-up-basic">
                              <span><?php echo $banner_index_ok_count_proportion; ?> %</span><i class="os-icon os-icon-ui-02"></i>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/banner_index'); ?>?type=2&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              待审核
                            </div>
                            <div class="value">
                             <?php echo $banner_index_wait_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                             <span><?php echo $banner_index_wait_count_proportion; ?> %</span><i class="os-icon os-icon-grid-18"></i>
                            </div>
                          </a>
                        </div>
                        <div class="d-none d-xxxl-block col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/banner_index'); ?>?type=3&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              驳回
                            </div>
                            <div class="value">
                              <?php echo $banner_index_no_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                              <span><?php echo $banner_index_no_count_proportion; ?> %</span><i class="os-icon os-icon-others-43"></i>
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <?php if(is_array($banner_index_list) || $banner_index_list instanceof \think\Collection || $banner_index_list instanceof \think\Paginator): $i = 0; $__LIST__ = $banner_index_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    
                        ...
                        <?php echo $banner_index_list->render(); ?>
