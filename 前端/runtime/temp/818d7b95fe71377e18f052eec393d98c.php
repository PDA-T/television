<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/a.topv.club/application/index/view/advertisement/launch_page.html";i:1573248304;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <div class="col-sm-12">
    <div class="element-wrapper">
      <div class="element-box">
        <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('advertisement/launch_page'); ?>" >
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text"  name="launchImageAd"  value="<?php echo advert('354'); ?>" >
                  </div>             
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text"  name="launchImageAd_bottom"  value="<?php echo advert('358'); ?>" >
                  </div>             
            ...
            <div class="col-sm-12">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="launchImageAd_url" value="<?php echo advert('355'); ?>" >
                  </div>             
          ...
          <div class="row">
            <div class="col-sm-6">
 				...
 				<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="launchImageAd_time" value="<?php echo advert('356'); ?>">
                  </div>             
                ...
                <div class="form-group ">
                  <div class="input-group">
                    <div class="input-group-prepend">
                     ...
                     <select class="form-control"  name="launchImageAd_skip"  value="<?php echo advert('357'); ?>">
                        <option value="0" <?php if(advert('357') == '0'){ echo 'selected';} ?>>不允许</option>
                        <option value="1" <?php if(advert('357') == '1'){ echo 'selected';} ?>>允许</option>
                    </select>
  ...
  <h6 class="element-header">
    预览
      ...
      <div id="phone">
          ...
          <div id="screen">              
           <img alt="" src="<?php echo advert('354'); ?>" style=" width: 100%; height: 80%; ">
        </div>
          <div id="btn"></div>
      </div>
...
background-image: url(<?php echo advert('358'); ?>);
