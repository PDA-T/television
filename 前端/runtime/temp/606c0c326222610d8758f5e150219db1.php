<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/www/wwwroot/a.topv.club/application/index/view/poster/add.html";i:1574101022;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
-->
  ...
  <div class="col-sm-5">
	...
	<div class="up-head-w" style="height: 750px; background-image:url(/public/static/v4/img/portfolio15.jpg)" >
              <div class="up-social">
  ...
  <div class="col-sm-7">
    <div class="element-wrapper">
      <div class="element-box">
         <form class="form-material"   role="form" id="form1" method="post" action="<?php echo url('poster/add'); ?>" >
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="poster_name">
                  </div>             
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
               	...
               	<div class="input-group">
                    ...
                    <input class="form-control" type="text" name="poster_img" >
                  </div>             
