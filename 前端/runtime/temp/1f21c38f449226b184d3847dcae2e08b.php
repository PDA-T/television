<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/a.topv.club/application/index/view/advertisement/big_picture_recommend.html";i:1584102348;s:59:"/www/wwwroot/a.topv.club/application/index/view/layout.html";i:1588953790;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <div class="content-w">
          ...
          -------------------->
                ...
                <div class="col-sm-12">
                  <div class="element-wrapper">
                    ...
                    <h6 class="element-header">
                      推荐页横幅广告概况 <?php echo $type_name; ?>
                    </h6>
                    <div class="element-content">
                      <div class="row">
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/big_picture_recommend'); ?>?Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              ALL
                            </div>
                            <div class="value">
                              <?php echo $big_picture_recommend_count; ?>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/big_picture_recommend'); ?>?type=1&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              审核通过
                            </div>
                            <div class="value">
                              <?php echo $big_picture_recommend_ok_count; ?>
                            </div>
                            <div class="trending trending-up-basic">
                              <span><?php echo $big_picture_recommend_ok_count_proportion; ?> %</span><i class="os-icon os-icon-ui-02"></i>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-4 col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/big_picture_recommend'); ?>?type=2&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              待审核
                            </div>
                            <div class="value">
                             <?php echo $big_picture_recommend_wait_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                             <span><?php echo $big_picture_recommend_wait_count_proportion; ?> %</span><i class="os-icon os-icon-grid-18"></i>
                            </div>
                          </a>
                        </div>
                        <div class="d-none d-xxxl-block col-xxxl-3">
                          <a class="element-box el-tablo" href="<?php echo url('advertisement/big_picture_recommend'); ?>?type=3&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>">
                            <div class="label">
                              驳回
                            </div>
                            <div class="value">
                              <?php echo $big_picture_recommend_no_count; ?>
                            </div>
                            <div class="trending trending-down-basic">
                              <span><?php echo $big_picture_recommend_no_count_proportion; ?> %</span><i class="os-icon os-icon-others-43"></i>
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="element-box">
                      <div class="table-responsive">
                        <table class="table table-lightborder">
                          ...
                          <?php if(is_array($big_picture_recommend_list) || $big_picture_recommend_list instanceof \think\Collection || $big_picture_recommend_list instanceof \think\Paginator): $i = 0; $__LIST__ = $big_picture_recommend_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>    

                            
                           
                            <tr  onclick="window.open(' <?php echo url('advertisement/edit'); ?>?edit_id=<?php echo $vo['id']; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>')" style="cursor:pointer">
                              <td class="nowrap">
                                <?php echo $vo['name']; ?>
                              </td>
                              <td>
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(<?php echo $vo['picurl']; ?>)"></div>
                                  <div class="cell-img-more" style="left: 80%;">
                                    <?php if($vo['audit'] == 2){ echo '待审核'; }else if($vo['audit'] == 3){ echo '驳回'; } ?>
                                  </div>
                                </div>
                              </td>
                              <td class="text-center">
                                <?php if($vo['audit'] == 1){  ?>
                                	<div class="status-pill green" data-title="通过" data-toggle="tooltip" data-original-title="" title=""></div> 
                                <?php }else if($vo['audit'] == 2){ ?> 
                                	<div class="status-pill  " data-title="待审核" data-toggle="tooltip" data-original-title="" title=""></div> 
                                <?php }else if($vo['audit'] == 3){ ?>
                                	<div class="status-pill red" data-title="驳回" data-toggle="tooltip" data-original-title="" title=""></div> 
                                <?php } ?>
                              </td>
                            </tr>
                        ...
                        <?php echo $big_picture_recommend_list->render(); ?>
            ...
            <div class="content-panel">
              ...
              <div class="element-wrapper">
                ...
                <div class="element-box-tp">
                  <div class="el-buttons-list full-width">
                    <a class="btn btn-primary btn-sm" href="<?php echo url('index/advanced_functions'); ?>"  target="_blank"><i class="os-icon os-icon-window-content"></i><span>当前：<?php if(advert('130') ==1){echo '开启代理广告展示';}else if(advert('130') ==0){echo '关闭代理广告展示';} ?></span></a>
                  </div>
                </div>
              </div>
              <!--------------------
              ...
              <div class="floated-chat-btn"  onclick="window.location.href = '<?php echo url('advertisement/add'); ?>?type=<?php echo $type; ?>&Ryan_time=<?php echo $Ryan_time; ?>&Ryan_key=<?php echo $Ryan_key; ?>'"  style="cursor:pointer">

                <span><i class="os-icon os-icon-pencil-1"></i><span>添加广告</span></span>
